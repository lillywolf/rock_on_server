...
//			_venue.structureController.serverController.sendRequest({id: this.id}, "owned_structure", "add_booth_credits");
//			UIBoss.createCollectible(new CoinsLeftover(), _venue.myWorld.getAssetFromOwnedStructure(this), _venue.myWorld);
//		}
//		
